---
title: "Visualization of Model Predicting Cumulative Utterances (Group by Risk Level)"
author: "Chunyen"
date: "2024/3/13"
output: 
  pdf_document:
...
CalcPrecision <- function(df, true_col, pred_col, average = "macro") {
  ...
  # classes <- sort(unique(c(true_labels, predicted_labels)))
...
CalcRecall <- function(df, true_col, pred_col, average = "macro") {
  ...
  # 接下来的代码与之前的 calculate_recall 函数相同
  conf_matrix <- table(predicted_labels, true_labels)
  # classes <- sort(unique(c(true_labels, predicted_labels)))
  classes <- levels(factor(true_labels))
...
transcript_caller_tib <- read_csv(paste0(processed_path, "transcripts_caller.csv"))
transcript_responser_tib <- read_csv(paste0(processed_path, "transcripts_responser.csv"))
...
tryCatch({
  ...
  groupedAllScores_tib <- groupedAllScores_tib %>% 
    ...
    # plot accuracy, recall, precision, F1 score grouped by risk level
    g1 <- groupedAllScores_tib %>% 
      ggplot(aes(x = cum_ut, y = accuracy, group = risk_group, color = risk_group)) +
      geom_line() +
    ...
    g2 <- groupedAllScores_tib %>%
      ggplot(aes(x = cum_ut, y = precision, group = risk_group, color = risk_group)) +
      geom_line() +
    ...
    g3 <- groupedAllScores_tib %>%
      ggplot(aes(x = cum_ut, y = recall, group = risk_group, color = risk_group)) +
      geom_line() +
    ...
    g4 <- groupedAllScores_tib %>%
      ggplot(aes(x = cum_ut, y = f1_score, group = risk_group, color = risk_group)) +
      geom_line() +
    ...
    # plot graded precision, recall, FScore grouped by risk level
  g5 <- groupedAllScores_tib %>% 
    ggplot(aes(x = cum_ut, y = graded_precision, group = risk_group, color = risk_group)) +
    geom_line() +
  ...
  g6 <- groupedAllScores_tib %>%
    ggplot(aes(x = cum_ut, y = graded_recall, group = risk_group, color = risk_group)) +
    geom_line() +
  ...
  g7 <- groupedAllScores_tib %>%
    ggplot(aes(x = cum_ut, y = FScore, group = risk_group, color = risk_group)) +
    geom_line() +
  ...
  # plot accuracy, grouped by risk level
  g1 <- groupedAllScores_tib %>%
   ggplot(aes(x = cum_ut, y = accuracy, group = risk_group, color = risk_group)) +
   geom_line() +
   labs(x = "Cumulative Utterance Number", y = "Accuracy", title = "Accuracy") +
  ...
  gridExtra::grid.arrange(g1, g5, g6, g7, ncol = 2,
                          top = "RF Model Non-Avg Metrics Over Cumulative Utterances (Risk5)"
                          )
})
```
...
tryCatch({
  ...
  gridExtra::grid.arrange(g1, g5, g6, g7, ncol = 2,
                          top = "BERT Model Non-Avg Metrics Over Cumulative Utterances (Risk5)"
                          )  
...
tryCatch({
  ...
  gridExtra::grid.arrange(g1, g5, g6, g7, ncol = 2,
                          top = "RF Model Non-Avg Metrics Over Cumulative Utterances (Risk4)"
                          )
})
```
...
tryCatch({
  ...
  gridExtra::grid.arrange(g1, g5, g6, g7, ncol = 2,
                          top = "BERT Model Non-Avg Metrics Over Cumulative Utterances (Risk4)"
                          )  
...
tryCatch({
  ...
  gridExtra::grid.arrange(g1, g5, g6, g7, ncol = 2,
                          top = "RF Model Non-Avg Metrics Over Cumulative Utterances (Risk3)"
                          )
})
```
...
tryCatch({
  ...
  gridExtra::grid.arrange(g1, g5, g6, g7, ncol = 2,
                          top = "BERT Model Non-Avg Metrics Over Cumulative Utterances (Risk3)"
                          )  
...
<!--     mutate(risk_group = !!sym(risklevel) %>% as.factor()) %>% -->
<!--     group_by(risk_group, cum_ut) %>% -->
<!--     yardstick::accuracy(!!sym(risklevel), y_pred) -->
...
<!--     mutate(risk_group = !!sym(risklevel) %>% as.factor()) %>% -->
<!--     group_by(risk_group, cum_ut) %>% -->
<!--     yardstick::precision(!!sym(risklevel), y_pred, estimator = "micro") -->
...
<!--     mutate(risk_group = !!sym(risklevel) %>% as.factor()) %>% -->
<!--     group_by(risk_group, cum_ut) %>% -->
<!--     yardstick::recall(!!sym(risklevel), y_pred, estimator = "micro") -->
...
<!--     mutate(risk_group = !!sym(risklevel) %>% as.factor()) %>% -->
<!--     group_by(risk_group, cum_ut) %>% -->
<!--     yardstick::f_meas(!!sym(risklevel), y_pred, estimator = "micro") -->
...
<!--     mutate(risk_group = !!sym(risklevel) %>% as.factor()) %>% -->
<!--     group_by(risk_group, cum_ut) %>% -->
<!--     yardstick::conf_mat(!!sym(risklevel), y_pred) -->

<!-- conf_mat_li$conf_mat -->
...
<!--       ) -->
<!--     ) %>%  -->
<!--     yardstick::recall(!!sym(risklevel), y_pred, estimator = "binary") -->
<!--     # yardstick::conf_mat(!!sym(risklevel), y_pred) -->
<!-- ``` -->
...
<!-- true_labels <- df %>% pull(risk3) -->
<!-- predicted_labels <- df %>% pull(y_pred) -->
